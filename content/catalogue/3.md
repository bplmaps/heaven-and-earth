...
Several Geophysical attributes can be easily distinguished; the two vivid white lines of the Yellow River (north) and the Yangzi River (south); just north of the Yellow River is the band of white "desert dots" of the Gobi and Taklamakan Deserts; and wave patterned oceans of the Atlantic (top left) to the Pacific (half of panel two on the right). There are two prominent man-made structures; The Great Wall, with its distinctive crenelated wall pattern, which runs between the Yellow River and the Gobi Desert; and the Willow Palisade, which emerges close to where the Great Wall ends and enters the sea, is demarcated by cross-hatched lines. 

This is an administrative map of the Qing empire with encoded toponyms (the key is in the large bottom right text box) marking the inner sphere of the eighteen provinces of "China proper" and the outer sphere made up of a surrounding ring of text blocks, with no borders of any kind, associated with non-Qing political entities that have official relations, and geographic proximity, with the Qing empire, including Russia, India, Thailand, Vietnam, Japan, and Korea. The administrative coding visually and easily enables a snapshot of the entire administrative, communications, and tax systems of the Qing empire.
