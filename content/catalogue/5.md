...
Part of the methodology and visual presentation of mapping Qing dynasty (1644-1910) China was formulated in the late Ming dynasty (1368-1644) during the mid-sixteenth century. Luo Hongxian (1504-64) in his well-known *Guang yutu* (*Expansive terrestrial atlas*) created the earliest atlas in China that was first printed in circa 1555. This slightly later edition, dated to 1566, has forty-six maps within the atlas. The first map, the *Complete terrestrial map* (*Yudi zongtu*), became a model for Qing map makers and was the foundation for the Huang family maps and eventually the blue terrestrial maps. 

In the Ming and Qing dynasties, administrators were responsible for supplying statistics about their administrative bodies.  That information, in Luo's atlas, was converted into twenty-four standardized symbols found in a key, the earliest use of an "encoded toponym." Instead of encircling the toponyms with the shape as on the blue maps, the *Guang yutu* shows the symbols in red next to the names as can be seen in the *Map of Zhejiang Province* (*Zhejiang yutu*). The atlas visually enabled an easy understanding of administrative and military divisions along with avenues of communication. The integration of text and image as seen here, where a shape was correlated with a place name that was only generally in a relational location is a cartographic typology that is unique to East Asian maps.
